    ...
    public class SystemCollectionsGenericDictionary_2_SystemStringUnityEngineGameObject_Wrap 
    {
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					System.Collections.Generic.Dictionary<string, UnityEngine.GameObject> __cl_gen_ret = new System.Collections.Generic.Dictionary<string, UnityEngine.GameObject>();
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<System.Collections.Generic.IEqualityComparer<string>>(L, 2))
				{
					...
					System.Collections.Generic.Dictionary<string, UnityEngine.GameObject> __cl_gen_ret = new System.Collections.Generic.Dictionary<string, UnityEngine.GameObject>(comparer);
					translator.Push(L, __cl_gen_ret);
                    
					return 1;
				}
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<System.Collections.Generic.IDictionary<string, UnityEngine.GameObject>>(L, 2))
				{
					System.Collections.Generic.IDictionary<string, UnityEngine.GameObject> dictionary = (System.Collections.Generic.IDictionary<string, UnityEngine.GameObject>)translator.GetObject(L, 2, typeof(System.Collections.Generic.IDictionary<string, UnityEngine.GameObject>));
					
					System.Collections.Generic.Dictionary<string, UnityEngine.GameObject> __cl_gen_ret = new System.Collections.Generic.Dictionary<string, UnityEngine.GameObject>(dictionary);
					translator.Push(L, __cl_gen_ret);
				...
				if(LuaAPI.lua_gettop(L) == 2 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
				{
					...
					System.Collections.Generic.Dictionary<string, UnityEngine.GameObject> __cl_gen_ret = new System.Collections.Generic.Dictionary<string, UnityEngine.GameObject>(capacity);
					translator.Push(L, __cl_gen_ret);
                    
					return 1;
				}
				if(LuaAPI.lua_gettop(L) == 3 && translator.Assignable<System.Collections.Generic.IDictionary<string, UnityEngine.GameObject>>(L, 2) && translator.Assignable<System.Collections.Generic.IEqualityComparer<string>>(L, 3))
				{
					System.Collections.Generic.IDictionary<string, UnityEngine.GameObject> dictionary = (System.Collections.Generic.IDictionary<string, UnityEngine.GameObject>)translator.GetObject(L, 2, typeof(System.Collections.Generic.IDictionary<string, UnityEngine.GameObject>));
					...
					System.Collections.Generic.Dictionary<string, UnityEngine.GameObject> __cl_gen_ret = new System.Collections.Generic.Dictionary<string, UnityEngine.GameObject>(dictionary, comparer);
					translator.Push(L, __cl_gen_ret);
				...
				if(LuaAPI.lua_gettop(L) == 3 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) && translator.Assignable<System.Collections.Generic.IEqualityComparer<string>>(L, 3))
				{
					...
					System.Collections.Generic.Dictionary<string, UnityEngine.GameObject> __cl_gen_ret = new System.Collections.Generic.Dictionary<string, UnityEngine.GameObject>(capacity, comparer);
					translator.Push(L, __cl_gen_ret);
        ...
        static int _m_Add(RealStatePtr L)
        {
		    try {
                ...
                System.Collections.Generic.Dictionary<string, UnityEngine.GameObject> __cl_gen_to_be_invoked = (System.Collections.Generic.Dictionary<string, UnityEngine.GameObject>)translator.FastGetCSObj(L, 1);
            
            
                
                {
                    string key = LuaAPI.lua_tostring(L, 2);
                    UnityEngine.GameObject value = (UnityEngine.GameObject)translator.GetObject(L, 3, typeof(UnityEngine.GameObject));
        ...
        static int _m_ContainsValue(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.GameObject value = (UnityEngine.GameObject)translator.GetObject(L, 2, typeof(UnityEngine.GameObject));
        ...
        static int _m_GetEnumerator(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        System.Collections.Generic.Dictionary<string, UnityEngine.GameObject>.Enumerator __cl_gen_ret = __cl_gen_to_be_invoked.GetEnumerator(  );
                        translator.Push(L, __cl_gen_ret);
