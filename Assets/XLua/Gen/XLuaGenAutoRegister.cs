    ...
    public class XLua_Gen_Initer_Register__
	{
	    static XLua_Gen_Initer_Register__()
        {
		    XLua.LuaEnv.AddIniter((luaenv, translator) => {
				...
				translator.DelayWrapLoader(typeof(UITimePage), UITimePageWrap.__Register);
				
				translator.DelayWrapLoader(typeof(UIPromptPage), UIPromptPageWrap.__Register);
				
				translator.DelayWrapLoader(typeof(UIManager), UIManagerWrap.__Register);
				
				translator.DelayWrapLoader(typeof(UIMovePage), UIMovePageWrap.__Register);
				
				translator.DelayWrapLoader(typeof(UIMovieQRCodePage), UIMovieQRCodePageWrap.__Register);
				
				translator.DelayWrapLoader(typeof(UIMessagePage), UIMessagePageWrap.__Register);
				
				translator.DelayWrapLoader(typeof(CommonMono), CommonMonoWrap.__Register);
				
				translator.DelayWrapLoader(typeof(CoroutineRuner), CoroutineRunerWrap.__Register);
